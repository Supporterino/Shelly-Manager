          ...
          <Accordion.Panel>
            <Stack gap={4}>
              <PhaseRow
                ...
                value={em != null ? formatPower(em.a_act_power, locale) : '—'}
              />
              <PhaseRow
                label={t('power.apparentPower')}
                value={em != null ? `${em.a_aprt_power.toFixed(1)} VA` : '—'}
              />
              <PhaseRow
                label={t('power.voltage')}
                value={em != null ? formatVoltage(em.a_voltage, locale) : '—'}
              />
              <PhaseRow
                label={t('power.current')}
                value={em != null ? formatCurrent(em.a_current, locale) : '—'}
              />
              <PhaseRow
                label={t('power.powerFactor')}
                value={em != null ? em.a_pf.toFixed(2) : '—'}
              />
              <PhaseRow
                label={t('power.frequency')}
                value={em != null ? `${em.a_freq.toFixed(1)} Hz` : '—'}
              />
            </Stack>
          </Accordion.Panel>
        </Accordion.Item>
        ...
        <Accordion.Item value="phaseB">
          ...
          <Accordion.Panel>
            <Stack gap={4}>
              <PhaseRow
                label={t('power.activePower')}
                value={em != null ? formatPower(em.b_act_power, locale) : '—'}
              />
              <PhaseRow
                label={t('power.apparentPower')}
                value={em != null ? `${em.b_aprt_power.toFixed(1)} VA` : '—'}
              />
              <PhaseRow
                label={t('power.voltage')}
                value={em != null ? formatVoltage(em.b_voltage, locale) : '—'}
              />
              <PhaseRow
                label={t('power.current')}
                value={em != null ? formatCurrent(em.b_current, locale) : '—'}
              />
              <PhaseRow
                label={t('power.powerFactor')}
                value={em != null ? em.b_pf.toFixed(2) : '—'}
              />
              <PhaseRow
                label={t('power.frequency')}
