...
import { WebhookManager } from '../../components/devices/webhooks/WebhookManager';
import { useDeviceStore } from '../../store/deviceStore';

export const Route = createFileRoute('/devices/$deviceId/webhooks')({
  component: DeviceWebhooksPage,
});

function DeviceWebhooksPage() {
  ...
  return (
    <ScrollArea h="100%">
      <Stack gap="md" p="md">
        ...
        <WebhookManager deviceId={deviceId} />
      </Stack>
    </ScrollArea>
  );
}
