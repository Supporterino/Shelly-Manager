...
describe('updateStatus', () => {
  ...
  it('deep-merges nested objects', () => {
    ...
    expect((useWsStatusStore.getState().statuses['dev1']['light:0'] as Record<string, unknown>).brightness).toBe(80)
    expect((useWsStatusStore.getState().statuses['dev1']['light:0'] as Record<string, unknown>).output).toBe(true)
  })
