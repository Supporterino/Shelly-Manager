...
describe('DiscoveryProgress', () => {
  ...
  it('shows no-devices-found message when done with empty list', () => {
    renderWithProviders(<DiscoveryProgress status="done" progress={[]} found={0} />);
  ...
  it('renders discovered hosts in the progress list', () => {
    ...
    renderWithProviders(<DiscoveryProgress status="done" progress={hosts} found={2} />);
